...
const ModalShowInfo: React.FC<Props> = ({
  ...
  return (
    <ModalBase className="bg-gray-400/30 backdrop-filter backdrop-blur-sm flex sm:justify-center sm:items-center">
      <div className="bg-gray-200 max-w-2xl min-h-screen overflow-y-auto sm:min-h-0 sm:h-auto shadow-2xl p-5 relative flex flex-col items-center rounded-md mx-auto">
        <button
          type="button"
          name="closeModal"
